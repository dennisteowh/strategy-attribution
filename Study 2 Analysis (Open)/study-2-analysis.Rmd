...
```{r figure = TRUE, fig.width=6, fig.height=6, fig.align='center', eval = FALSE}
...
strategy.success.method.report <- collapse.report(strategy.success)
...
strategy.fail.method.report <- collapse.report(strategy.fail)
...
effort.success.method.report <- collapse.report(effort.success)
...
effort.fail.method.report <- collapse.report(effort.fail)
...
aptitude.success.method.report <- collapse.report(aptitude.success)
...
aptitude.fail.method.report <- collapse.report(aptitude.fail)
...
```{r echo = FALSE, warning=FALSE, message=FALSE, results='hide'}
attobo2.posterior.coefs <- select(pred.method, `strategy.sim`, `effort.sim`,`aptitude.sim`)
...
aptitude.fail.mean <- collapse.mean(aptitude.fail) %>%
  select(mean)

aptitude.success.mean <- collapse.mean(aptitude.success) %>%
  select(mean)

effort.fail.mean <- collapse.mean(effort.fail) %>%
  select(mean)

effort.success.mean <- collapse.mean(effort.success) %>%
  select(mean)

strategy.fail.mean <- collapse.mean(strategy.fail) %>%
  select(mean)

strategy.success.mean <- collapse.mean(strategy.success) %>%
  select(mean)
...
attobo2.plot <- gather(attobo2.pp)
...
strategy.success.bruteforce.report <- collapse.report(strategy.success)
...
strategy.fail.bruteforce.report <- collapse.report(strategy.fail)
...
effort.success.bruteforce.report <- collapse.report(effort.success)
...
effort.fail.bruteforce.report <- collapse.report(effort.fail)
...
aptitude.success.bruteforce.report <- collapse.report(aptitude.success)
...
aptitude.fail.bruteforce.report <- collapse.report(aptitude.fail)
...
```{r echo = FALSE, warning=FALSE, message=FALSE, results='hide'}
attobo2.posterior.coefs <- select(pred.bruteforce, `strategy.sim`, `effort.sim`,`aptitude.sim`)
names(attobo2.posterior.coefs) <- c("Strategy", "Effort", "Aptitude")
...
strategy.success.redo.report <- collapse.report(strategy.success)
...
strategy.fail.redo.report <- collapse.report(strategy.fail)
...
effort.success.redo.report <- collapse.report(effort.success)
...
effort.fail.redo.report <- collapse.report(effort.fail)
...
aptitude.success.redo.report <- collapse.report(aptitude.success)
...
aptitude.fail.redo.report <- collapse.report(aptitude.fail)
...
#save(error.redo, file = "error.redo.RData")
...
```{r echo = FALSE, warning=FALSE, message=FALSE, results='hide'}
attobo2.posterior.coefs <- select(pred.redo, `strategy.sim`, `effort.sim`,`aptitude.sim`)
names(attobo2.posterior.coefs) <- c("Strategy", "Effort", "Aptitude")
...
strategy.success.redo.feedback.report <- collapse.report(strategy.success)
...
strategy.fail.redo.feedback.report <- collapse.report(strategy.fail)
...
effort.success.redo.feedback.report <- collapse.report(effort.success)
...
effort.fail.redo.feedback.report <- collapse.report(effort.fail)
...
aptitude.success.redo.feedback.report <- collapse.report(aptitude.success)
...
aptitude.fail.redo.feedback.report <- collapse.report(aptitude.fail)
...
#save(error.redo.feedback, file = "error.redo.feedback.RData")
...
```{r echo = FALSE, warning=FALSE, message=FALSE, results='hide'}
attobo2.posterior.coefs <- select(pred.redo.feedback, `strategy.sim`, `effort.sim`,`aptitude.sim`)
names(attobo2.posterior.coefs) <- c("Strategy", "Effort", "Aptitude")
...
strategy.success.redo.nofeedback.report <- collapse.report(strategy.success)
...
strategy.fail.redo.nofeedback.report <- collapse.report(strategy.fail)
...
effort.success.redo.nofeedback.report <- collapse.report(effort.success)
...
effort.fail.redo.nofeedback.report <- collapse.report(effort.fail)
...
aptitude.success.redo.nofeedback.report <- collapse.report(aptitude.success)
...
aptitude.fail.redo.nofeedback.report <- collapse.report(aptitude.fail)
...
#save(error.redo.nofeedback, file = "error.redo.nofeedback.RData")
...
```{r echo = FALSE, warning=FALSE, message=FALSE, results='hide'}
attobo2.posterior.coefs <- select(pred.redo.nofeedback, `strategy.sim`, `effort.sim`,`aptitude.sim`)
names(attobo2.posterior.coefs) <- c("Strategy", "Effort", "Aptitude")
...
attobo2.fit.mcmc <- as.mcmc(attobo2.fit)
#save(attobo2.fit.mcmc, file = "attobo2.expectancy.RData")
...
strategy.success.expectancy.report <- collapse.report(strategy.success)
strategy.success.expectancy.report
...
strategy.fail.expectancy.report <- collapse.report(strategy.fail)
...
effort.success.expectancy.report <- collapse.report(effort.success)
...
effort.fail.expectancy.report <- collapse.report(effort.fail)
...
aptitude.success.expectancy.report <- collapse.report(aptitude.success)
...
aptitude.fail.expectancy.report <- collapse.report(aptitude.fail)
...
```{r echo = FALSE, warning=FALSE, message=FALSE, results='hide'}
attobo2.posterior.coefs <- select(pred.expectancy, `strategy.sim`, `effort.sim`,`aptitude.sim`)
names(attobo2.posterior.coefs) <- c("Strategy", "Effort", "Aptitude")
